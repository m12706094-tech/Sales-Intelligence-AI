...
export const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex h-full bg-zinc-50 overflow-hidden">
      <aside className={cn(
        'bg-[#171717] text-zinc-200 border-r border-zinc-800 transition-all duration-300 flex flex-col',
          ...
          {!sidebarCollapsed && (
            <>
              <button
                ...
                className="flex-1 bg-zinc-800 hover:bg-zinc-700 rounded-lg px-3 py-2 text-sm flex items-center gap-2"
              >
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-1">
          {chats.map(chat => (
            ...
            >
              {editingChatId === chat.id && !sidebarCollapsed ? (
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    title={chat.title}
                  >
                    {sidebarCollapsed ? chat.title.charAt(0).toUpperCase() : chat.title}
                  </button>
                  {!sidebarCollapsed && (
