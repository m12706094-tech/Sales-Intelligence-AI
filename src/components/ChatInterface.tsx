...
const initialAssistantMessage: Message = {
  role: 'assistant',
  content: `Welcome to Clario.
Your intelligent sales insight assistant.

Ask about revenue, growth, performance trends, forecasting, or anomalies — and I’ll deliver clear, decision-ready answers.`
};
...
export const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex h-full bg-[#c8cbd4] overflow-hidden">
      <aside className={cn(
        'relative bg-[#222533] text-zinc-100 border-r border-[#2f3345] transition-all duration-300 flex flex-col rounded-l-2xl rounded-r-none shadow-2xl',
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-white rounded-r-2xl rounded-l-none border border-[#2d3040]/20 shadow-xl">
